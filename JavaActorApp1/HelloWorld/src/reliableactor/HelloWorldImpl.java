...
*/
@ActorServiceAttribute(name = "HelloWorldService")
@StatePersistenceAttribute(statePersistence = StatePersistence.Persisted)
public class HelloWorldImpl extends FabricActor implements HelloWorld {
    private Logger logger = Logger.getLogger(this.getClass().getName());

    public HelloWorldImpl(FabricActorService actorService, ActorId actorId){
